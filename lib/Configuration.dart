...
const Map IndicatorSpecs = {
  ...
  'BoatVectorsIndicator' : ['ATW_Stream','ST_Stream','AA_Stream','SA_Stream','HT_Stream','COG_Stream','SOG_Stream','LatLng_Stream','DBK_Stream','DBS_Stream','DBT_Stream','DBST_Stream'],
