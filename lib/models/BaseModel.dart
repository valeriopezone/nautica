...
class BaseModel extends Listenable {
  ...
  Color backgroundForm = Colors.white;
  Color formSetColor = Color.fromRGBO(204, 204, 204, 1.0);
  Color formLabelTextColor = Colors.black54;
  Color formInputTextColor = Colors.black87;
  Color formSectionLabelColor = Color.fromRGBO(0, 91, 79, 1.0);
  ...
  List<Color> darkPaletteColors = <Color>[const Color.fromRGBO(0, 116, 227, 1), Colors.transparent, Colors.transparent, Colors.transparent, Colors.transparent];
  ...
  void _setDarkColors() {
    ...
    backgroundForm = Color.fromRGBO(33, 33, 33, 1);
    formSectionLabelColor = Color.fromRGBO(78, 186, 170, 1);
    formSetColor = Colors.white;
    formLabelTextColor = Colors.white;
    formInputTextColor = Colors.white;
  }
  ...
  void _setLightColors() {
    ...
    formSetColor = Color.fromRGBO(204, 204, 204, 1.0);
    formSectionLabelColor = Color.fromRGBO(0, 91, 79, 1);
    formLabelTextColor = Colors.black54;
    formInputTextColor = Colors.black87;
  }
